...
public class AdvancedScenario1 {
	...
	private static void deleteuser1()
	{
		try
		{
			...
			browser.findElement(objectmap.getLocator("clickonuser1tomodifypwd")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickondeleteforuser1")).click();
			Thread.sleep(1000);
	...
	private static void deleteuser2()
	{
		try
		{
			browser.findElement(objectmap.getLocator("clickoncreateusers")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("selectuser2todelete")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickondeleteforuser1")).click();
			Thread.sleep(1000);
			Alert obj=browser.switchTo().alert();
	...
	private static void deleteuser3()
	{
		try
		{
			browser.findElement(objectmap.getLocator("clickoncreateusers")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("selectuser3todelete")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickondeleteforuser1")).click();
			Thread.sleep(1000);
			Alert obj=browser.switchTo().alert();
