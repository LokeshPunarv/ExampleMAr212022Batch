...
public class BasicScenario7 {
	...
	private static void addtask()
	{
		try
		{
			browser.findElement(objectmap.getLocator("clickonaddnewtask")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickoncreatetaskforproject")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("entertaskfieldinnewtask")).sendKeys("Task1");
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clicktocreatetasktosave")).click();
			Thread.sleep(1000);
	...
	private static void deletetask()
	{
		try
		{
			...
			browser.findElement(objectmap.getLocator("clickontaskcreated")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickonactionintask")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickondeleteintask")).click();
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("clickondeletepermanentintask")).click();
			Thread.sleep(1000);
