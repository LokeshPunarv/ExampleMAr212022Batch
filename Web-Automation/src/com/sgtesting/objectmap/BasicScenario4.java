...
public class BasicScenario4 {
	...
	private static void modifycustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("modifyincustomerdescriptionfield")).sendKeys("This is Banking Project");
			Thread.sleep(1000);
			browser.findElement(objectmap.getLocator("Clickonclosebuttonincustomermodifyfield")).click();
			Thread.sleep(1000);
