...
public class BasicScenarioTestNG4 {
	...
	private static void modifycustomer(String modcname)
	 {
		try {
			...
			Thread.sleep(1000);
			obrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[2]/div[1]/div[3]/div/div[2]/input")).sendKeys(modcname);
			Thread.sleep(1000);
