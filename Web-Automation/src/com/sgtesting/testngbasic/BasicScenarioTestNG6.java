...
public class BasicScenarioTestNG6 {
	...
	@Test(priority=7,dataProvider="modifyprojectdetails")
	private static void modifyproject(String modpname ) {
		try {
			obrowser.findElement(By.xpath("//*[@id=\'topnav\']/tbody/tr[1]/td[3]/a/div[1]")).click();
			Thread.sleep(1000);
			...
			Thread.sleep(1000);
			obrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys(modpname);
			Thread.sleep(1000);
	...
	@DataProvider(name="modifyprojectdetails")
	public Object[][] getmodifyprojectdetailsdata()
	{
